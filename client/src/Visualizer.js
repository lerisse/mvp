...
export default function Visualizer (props) {
  ...
  let preload = (p5) => {
    song = p5.loadSound('/client/src/assets/test2.mp3');
  ...
  // class Particle exten<Sketch preload={preload} setup={setup} draw={draw} mousePressed={mousePressed} />
